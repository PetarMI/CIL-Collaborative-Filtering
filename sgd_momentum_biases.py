...
def sgd_update(train_samples, U, M, l_rate, mu, bu, bi, prev_delta_U, prev_delta_M, prev_delta_bu, \
    prev_delta_bi):
    ...
    delta_bu = beta * prev_delta_bu
    delta_bi = beta * prev_delta_bi
    ...
    return U, M, bu, bi, delta_U, delta_M, delta_bu, delta_bi
